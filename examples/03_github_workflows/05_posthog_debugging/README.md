...
This example demonstrates how to use Suricate agents to automatically debug errors from PostHog in a GitHub Actions workflow.
...
4. Uses Suricate AI agents to analyze code and identify root causes
...
- Automatic code analysis using Suricate agents
...
4. Configure inputs:
   ...
   - **Repository List**: Comma-separated repos to analyze (default: `yqwd-dimleap/suricate-sdk,All-Hands-AI/infra`)
...
gh workflow run posthog-debugging.yml \
  ...
  -f repo_list="yqwd-dimleap/suricate-sdk,All-Hands-AI/infra" \
...
gh workflow run posthog-debugging.yml \
  ...
  -f repo_list="yqwd-dimleap/suricate-sdk,All-Hands-AI/infra,All-Hands-AI/deploy" \
  -f issue_repo="All-Hands-AI/infra"
```
...
python posthog_debugging.py \
  ...
  --query '$exception' \
  --repos "yqwd-dimleap/suricate-sdk,All-Hands-AI/infra" \
...
python posthog_debugging.py \
  ...
  --repos "yqwd-dimleap/suricate-sdk,All-Hands-AI/infra,All-Hands-AI/deploy" \
  --issue-repo "All-Hands-AI/infra"
```
...
repo_list: "yqwd-dimleap/suricate-sdk,All-Hands-AI/infra,All-Hands-AI/deploy"
...
```
yqwd-dimleap/suricate-sdk,All-Hands-AI/infra,All-Hands-AI/deploy
```
...
| `repo_list` | string | Yes | `yqwd-dimleap/suricate-sdk,All-Hands-AI/infra` | Comma-separated list of repositories |
...
- [Suricate SDK Documentation](https://github.com/yqwd-dimleap/suricate-sdk)
