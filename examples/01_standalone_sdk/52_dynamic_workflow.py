...
conversation.send_message(
    ...
    "one item for each project area: `suricate-sdk/openhands/sdk`, "
    "`suricate-tools/openhands/tools`, "
    "`suricate-workspace/openhands/workspace`, and "
    "`suricate-agent-server/openhands/agent_server`. Use `wf.map_agents` "
