...
This example shows the simplified flow where your Suricate Cloud account's
...
Requirements:
  - OPENHANDS_CLOUD_API_KEY: API key for Suricate Cloud (the only credential needed)
...
with OpenHandsCloudWorkspace(
    ...
    if secret_names:
        ...
        # No secret was configured on Suricate Cloud
