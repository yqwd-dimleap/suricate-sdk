...
def temp_user_skills_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        skills_dir = root / ".suricate" / "skills"
...
def temp_microagents_dir():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        microagents_dir = root / ".suricate" / "microagents"
...
def test_load_user_skills_with_skills_directory(temp_user_skills_dir):
    """Test load_user_skills loads from .suricate/skills directory."""
...
def test_load_user_skills_priority_order(tmp_path):
    """Test precedence .agents/skills > .suricate/skills > microagents."""
...
def test_load_user_skills_merges_all_directories(tmp_path):
    """Test loading unique skills from .agents/skills, .suricate/skills,
    microagents.
    """
    agents_dir = tmp_path / ".agents" / "skills"
    skills_dir = tmp_path / ".suricate" / "skills"
