...
def test_acp_agent_settings_export_schema_has_acp_section() -> None:
    ...
    # mcp_config is exposed as a single object field (matching the Suricate
...
def test_conversation_settings_validates_observability_metadata() -> None:
    settings = ConversationSettings(observability_metadata={"repo": "Suricate/sdk"})
    assert settings.observability_metadata == {"repo": "Suricate/sdk"}
...
def test_export_agent_settings_schema_emits_variant_tagged_sections() -> None:
    ...
    # Memory section is Suricate-only: the GUI matches sections by key and
