---
title: Suricate SDK Tests
description: Test suite structure and execution strategy for the Suricate SDK. Includes unit tests, integration tests, and CI configuration.
---

# Suricate SDK Tests

This directory contains the test suite for the Suricate SDK.
