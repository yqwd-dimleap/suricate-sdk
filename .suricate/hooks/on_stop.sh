...
if [ -n "$CHANGED_FILES" ]; then
    ...
    while IFS= read -r file; do
        case "$file" in
            suricate-sdk/*) add_project "tests/sdk" ;;
            suricate-tools/*) add_project "tests/tools" ;;
            suricate-workspace/*) add_project "tests/workspace" ;;
            suricate-agent-server/*) add_project "tests/agent_server" ;;
