...
class ServerInfo(BaseModel):
    uptime: float
    idle_time: float
    title: str = "Suricate Agent Server"

    version: str = Field(
        default_factory=lambda: _package_version("suricate-agent-server")
    )
    sdk_version: str = Field(default_factory=lambda: _package_version("suricate-sdk"))
    tools_version: str = Field(
        default_factory=lambda: _package_version("suricate-tools")
    )
    workspace_version: str = Field(
        default_factory=lambda: _package_version("suricate-workspace")
    )
