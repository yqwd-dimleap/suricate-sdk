...
class _ConversationInfoBase(BaseModel):
    ...
    current_model_id: str | None = Field(
        ...
        description=(
            ...
            "still initializing. Native Suricate agents leave this ``None`` — "
    ...
    available_models: list[ACPModelInfo] = Field(
        ...
        description=(
            ...
            "the (UNSTABLE) capability and for native Suricate agents. "
    ...
    supports_runtime_model_switch: bool = Field(
        ...
        description=(
            ...
            "``False`` for native "
            "Suricate agents, for a known provider that declares no support, "
...
def trim_conversation_response_skills(info: ConversationInfo) -> ConversationInfo:
    ...
    actually reads from the HTTP response (agent-canvas, Suricate
