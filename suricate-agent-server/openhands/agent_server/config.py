...
# 20 minutes, matching the idle timeout used by Suricate Cloud.
...
class TelemetrySpec(BaseModel):
    ...
    deployment_kind: DeploymentKind = Field(
        ...
        description=(
            ...
            "hosted Suricate and 'local' for self-hosted or developer runs."
        ),
    )
...
class Config(BaseModel):
    ...
    acp_skill_sourcing: ACPSkillSourcing = Field(
        ...
        description=(
            ...
            "user's own home configuration and the repository, so Suricate "
