...
# suricate-sdk[vertex] extra first, or pass ENABLE_VERTEX=1 to the Docker build,
...
if _VERTEX_AVAILABLE:
    ...
    print(
        ...
        "Install suricate-sdk[vertex] before building to include it."
    )
...
PATHEX = [
    project_root / "suricate-agent-server",
    project_root / "suricate-sdk",
    project_root / "suricate-tools",
    project_root / "suricate-workspace",
]

# Entry script for the agent server package (namespace: openhands/agent_server/__main__.py)
ENTRY = str(project_root / "suricate-agent-server" / "openhands" / "agent_server" / "__main__.py")
...
a = Analysis(
    ...
    datas=[
        ...
        *copy_metadata("suricate-agent-server"),
        *copy_metadata("suricate-sdk"),
        *copy_metadata("suricate-tools"),
        *copy_metadata("suricate-workspace"),
    ...
    hiddenimports=[
        ...
        *collect_submodules("rich"),
        ...
        # if suricate-sdk[vertex] is not installed in the build env).
        *_vertex_hiddenimports,
