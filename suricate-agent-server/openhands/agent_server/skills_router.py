"""Skills router for Suricate Agent Server.
...
class SkillsRequest(BaseModel):
    ...
    load_public: bool = Field(
        default=True, description="Load public skills from Suricate/extensions repo"
    )
    load_user: bool = Field(
        default=True, description="Load user skills from ~/.suricate/skills/"
    )
...
class InstallSkillRequest(BaseModel):
    ...
    source: str = Field(
        ...
        description=(
            ...
            "Examples: "
            "'https://github.com/yqwd-dimleap/extensions/tree/main/skills/github', "
            "'github:Suricate/extensions/skills/github', "
            "'/path/to/skill'"
        ),
    )
    ref: str | None = Field(
...
def get_skills(request: SkillsRequest, http_request: Request) -> SkillsResponse:
    ...
    2. Public skills - From GitHub Suricate/extensions repository
    3. User skills - From ~/.suricate/skills/
    4. Organization skills - From {org}/.openhands or equivalent
    5. Project skills (highest) - From {workspace}/.suricate/skills/
...
def install_skill_endpoint(request: InstallSkillRequest) -> InstalledSkillResponse:
    ...
    the user's installed skills directory (~/.suricate/skills/installed/).
...
def list_installed_skills_endpoint() -> InstalledSkillsListResponse:
    ...
    directory (~/.suricate/skills/installed/).
...
def get_marketplace_catalog() -> MarketplaceCatalogResponse:
    ...
    Returns a list of available skills from the Suricate extensions
