...
def sanitize_openhands_mentions(text: str) -> str:
    """Sanitize @Suricate mentions in text to prevent self-mention loops.

    This function inserts a zero-width joiner (ZWJ) after the @ symbol in
    @Suricate mentions, making them non-clickable in GitHub comments while
    ...
    Returns:
        Text with sanitized @Suricate mentions (e.g., "@Suricate" -> "@‍Suricate")

    Examples:
        >>> sanitize_openhands_mentions("Thanks @Suricate for the help!")
