#!/usr/bin/env python3
"""Convert legacy Suricate skills to AgentSkills standard format.
...
- Preserves Suricate-specific fields (triggers, inputs) for compatibility
...
def generate_description(
    ...
    return "A skill for Suricate agent."
...
def convert_legacy_skill(
    ...
    """Convert a legacy Suricate skill to AgentSkills format."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Convert legacy Suricate skills to AgentSkills standard format",
