"""Streamlit app to explore Suricate conversation logs.
...
st.set_page_config(page_title="Suricate Agent-SDK Conversation Viewer", layout="wide")
...
def main() -> None:
    st.title("Suricate Conversation Viewer")
    ...
    root_input = st.sidebar.text_input(
        ...
        help="Root folder containing Suricate conversation dumps",
    )
