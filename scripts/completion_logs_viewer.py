"""Streamlit app to explore Suricate completion logs.
...
st.set_page_config(page_title="Suricate Completion Logs Viewer", layout="wide")
...
def main() -> None:
    st.title("Suricate Completion Logs Viewer")
    ...
    root_input = st.sidebar.text_input(
        ...
        help="Root folder containing Suricate completion logs",
    )
