"""Skill management for Suricate SDK.
...
- `load_user_skills` - Load skills from ~/.suricate/skills/
- `load_public_skills` - Load skills from the public Suricate extensions repo
