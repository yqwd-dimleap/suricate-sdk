...
<html>
<head>
  <title>Suricate - Authorization Successful</title>
  <style>
...
<body>
  <div class="container">
    ...
    <p>You can close this window and return to Suricate.</p>
  </div>
...
<html>
<head>
  <title>Suricate - Authorization Failed</title>
  <style>
    body { font-family: system-ui, sans-serif; display: flex;
           justify-content: center; align-items: center; height: 100vh;
           margin: 0; background: #1a1a2e; color: #eee; }
    ...
    def create_llm(
        ...
        **llm_kwargs: Any,
        ...
        extra_headers: dict[str, str] = {
            ...
            "User-Agent": f"suricate-sdk ({platform.system()}; {platform.machine()})",
        }
        if account_id:
