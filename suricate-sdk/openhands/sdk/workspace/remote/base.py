...
class RemoteWorkspace(RemoteWorkspaceMixin, BaseWorkspace):
    ...
    def _convert_skill_data_to_skill(self, skill_data: dict[str, Any]) -> "Skill":
        ...
        if triggers:
            # Determine trigger type based on content (same logic as Suricate)
    ...
    def load_skills_from_agent_server(
        ...
        Args:
            ...
            load_public: Load public skills from Suricate/extensions repo.
            load_user: Load user skills from ~/.suricate/skills/.
