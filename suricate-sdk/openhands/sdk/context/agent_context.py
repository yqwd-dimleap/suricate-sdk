...
class AgentContext(BaseModel):
    ...
    load_user_skills: bool = Field(
        default=False,
        description=(
            "Whether to automatically load user skills from ~/.suricate/skills/ "
            "and ~/.suricate/microagents/ (for backward compatibility). "
        ),
        json_schema_extra={"acp_compatible": True},
    )
    ...
    load_project_skills: bool = Field(
        ...
        description=(
            ...
            "workspace (e.g. .suricate/skills/, AGENTS.md). Unlike "
    ...
    load_memory: bool = Field(
        ...
        description=(
            ...
            "~/.suricate/memory/ and <workspace>/.suricate/memory/) into the "
