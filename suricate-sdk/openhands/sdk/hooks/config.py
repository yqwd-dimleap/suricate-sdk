...
class HookConfig(BaseModel):
    ...
    def load(
        ...
        """Load config from path or search .suricate/hooks.json locations.

        Args:
            path: Explicit path to hooks.json file. If provided, working_dir is ignored.
            working_dir: Project directory for discovering .suricate/hooks.json.
