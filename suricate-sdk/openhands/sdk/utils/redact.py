...
Copies / consumers (keep in sync when changing):
  - Suricate/runtime-api  →  utils/redact.py  (partial copy)
  - All-Hands-AI/Suricate →  imports directly
"""
...
_API_KEY_LITERAL_RE = re.compile(
    ...
    r"|sk-oh-[A-Za-z0-9_-]{10,}"  # Suricate API keys
...
def redact_api_key_literals(text: str) -> str:
    ...
    Suricate session tokens, etc.) anywhere in the text.
