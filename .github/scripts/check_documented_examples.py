...
def main() -> None:
    ...
    if undocumented:
        ...
        print("   git clone https://github.com/yqwd-dimleap/docs.git")
        print()
        ...
        print(
            "   https://github.com/yqwd-dimleap/docs/blob/main/.github/scripts/README.md"
        )
        print()
        print("5. Example documentation files can be found in:")
        print("   https://github.com/yqwd-dimleap/docs/tree/main/sdk/guides")
        print()
