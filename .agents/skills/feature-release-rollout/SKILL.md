...
This skill guides the complete feature release workflow across the Suricate ecosystem repositories.

## Overview

When a feature is implemented in the SDK, it may need propagation through several repositories:

1. **SDK** (`yqwd-dimleap/suricate-sdk`) — Core feature implementation
2. **CLI** (`yqwd-dimleap/suricate-desktop`) — Terminal interface support
3. **GUI** (`yqwd-dimleap/suricate-sdk` frontend directory) — Web interface support
4. **Docs** (`Suricate/docs`) — Documentation updates (sdk/ folder)
5. **Blog** (`Suricate/growth-utils` blog-post/) — Marketing and announcements
...
git clone https://github.com/yqwd-dimleap/suricate-sdk.git
git clone https://github.com/yqwd-dimleap/suricate-desktop.git
git clone https://github.com/yqwd-dimleap/suricate-desktop.git        # Frontend in frontend/
git clone https://github.com/yqwd-dimleap/docs.git
git clone https://github.com/yqwd-dimleap/growth-utils.git
```
...
| GUI | `Suricate/frontend/src/` | React components, API integrations |
...
gh issue create --repo yqwd-dimleap/suricate-desktop \
...
### CLI (yqwd-dimleap/suricate-desktop)
...
### GUI (yqwd-dimleap/suricate-sdk frontend)
...
# Check CLI support
grep -r "feature_name" Suricate-CLI/openhands_cli/ --include="*.py"

# Check GUI support
grep -r "featureName" Suricate/frontend/src/ --include="*.ts" --include="*.tsx"
