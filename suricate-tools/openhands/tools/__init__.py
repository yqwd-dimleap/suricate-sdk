...
This is the primary import surface for the published ``suricate-tools``
distribution.
...
downstream consumers (e.g., Suricate-CLI) to bundle the browser-use package
...
try:
    __version__ = version("suricate-tools")
